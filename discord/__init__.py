...
__author__ = 'Rapptz, Dolfies, Nes'
__license__ = 'MIT'
__copyright__ = 'Copyright 2020-2024 nighty.one'
__version__ = '2.1a'
...
class _VersionInfo(NamedTuple):
    ...
    minor: int
    micro: int
    releaselevel: Literal['beta', 'final', 'stable', 'revisited']
    serial: int
version_info: _VersionInfo = _VersionInfo(
    major=2, minor=0, micro=0, releaselevel='revisited', serial=2)
